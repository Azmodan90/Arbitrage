...
class PairArbitrageStrategy:
    ...
    async def check_opportunity(self, asset):
        ...
        # Obliczenia na podstawie tickerów (do wstępnego filtrowania)
        ...
        # Przygotowujemy dane do logowania w formie tabeli
